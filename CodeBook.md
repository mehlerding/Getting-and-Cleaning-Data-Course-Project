...
This code book summarizes the data transformations and resulting data fields for  "tidy_data_means.txt".
...
* `activitydesc` - The type of activity occuring when the measurements were taken

## Activity Labels (activitydesc factors)

* `WALKING` : subject was walking during the measurements
* `WALKING_UPSTAIRS` : subject was walking up stairs during the measurements
* `WALKING_DOWNSTAIRS` : subject was walking down stairs during the measurements
